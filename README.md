## 项目名称
[![](https://www.herokucdn.com/deploy/button.png)](https://heroku.com/deploy?template=https://github.com/BlueKenda/KatunYouxi.git)
...
|  名称 | 值  | 说明  |
| ------------ | ------------ | ------------ |
|  PROTOCOL |  vme<br>vle（可选） |  协议：nginx+vme+ws+tls或是nginx+vle+ws+tls |
